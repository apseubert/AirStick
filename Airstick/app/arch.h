...
typedef struct
{
    uint32_t rcx_freq;
    uint32_t rcx_period;
    uint64_t rcx_slot_duration;
} rcx_time_data_t;

typedef struct
{
    uint32_t rcx_freq_min;
    uint32_t rcx_freq_max;
    uint32_t rcx_period_last;
    uint32_t rcx_period_diff;
} rcx_stats_data_t;
...
extern volatile uint32_t startup_sleep_delay;
...
// Preferred LDO_RET_TRIM value for sleep
#if defined (__DA14531__)
#if defined (__DA14535__)
#define PREF_LDO_RET_TRIM_VAL       (0xF)
#else
#define PREF_LDO_RET_TRIM_VAL       (0xE)
#endif
#endif
...
#if defined (__DA14531__)
#define PACKAGE_QFN_24      (0x000000AA)
#define PACKAGE_WLCSP_17    (0x000000FF)
#define DEVICE_DA14533      (0x00003300)
#define DEVICE_DA14534      (0x00003400)
#define DEVICE_DA14535      (0x00003500)
...
#if defined (__DA14535__)
// Only one package (FCGQFN24) is used for DA14533, DA14534, DA14535
#define DEFAULT_XTAL32M_TRIM_DA14533        (0x94)      // TODO
#define DEFAULT_XTAL32M_TRIM_DA14534        (0x94)      // TODO
#define DEFAULT_XTAL32M_TRIM_DA14535        (0x90)
...
#if defined (__DA14531__)
#define RUNNING_AT_XTAL_MAIN   RUNNING_AT_XTAL32M
#define XTAL_MAIN_SETTLED      XTAL32M_SETTLED
#else
#define RUNNING_AT_XTAL_MAIN   RUNNING_AT_XTAL16M
#define XTAL_MAIN_SETTLED      XTAL16_SETTLED
#endif
...
#if defined (CFG_ENABLE_WAKEUP_METRICS) && (!USE_XTAL16M_ADAPTIVE_SETTLING)
#define ENABLE_WAKEUP_METRICS                           1
#else
#define ENABLE_WAKEUP_METRICS                           0
#endif

#if defined (__DA14531__)
#if defined (CFG_RF_LDO_CALIBRATION)
#ifndef CFG_RF_DIAG_INT
#define CFG_RF_DIAG_INT
#endif
#define USE_RF_LDO_CALIBRATION                          1
#else
#define USE_RF_LDO_CALIBRATION                          0
#endif // CFG_RF_LDO_CALIBRATION
#endif
...
#if defined (__DA14531__)
#if defined (CFG_SPI_FLASH_EXTENSIONS)
#define USE_SPI_FLASH_EXTENSIONS                        1
#else
#define USE_SPI_FLASH_EXTENSIONS                        0
#endif // CFG_SPI_FLASH_EXTENSIONS
#else
#define USE_SPI_FLASH_EXTENSIONS                        0
#endif // __DA14531__

#if defined (__DA14531__) && defined (CFG_SPI_FLASH_EXTENSIONS)
#if defined (CFG_SPI_FLASH_CAP_SLOW_DISCHARGE)
#define USE_SPI_FLASH_CAP_SLOW_DISCHARGE                1
#else
#define USE_SPI_FLASH_CAP_SLOW_DISCHARGE                0
#endif // CFG_SPI_FLASH_CAP_SLOW_DISCHARGE
#else
#define USE_SPI_FLASH_CAP_SLOW_DISCHARGE                0
#endif // __DA14531__ && CFG_SPI_FLASH_EXTENSIONS

#if defined (__DA14531__) && defined (CFG_SPI_FLASH_EXTENSIONS)
#if defined (CFG_SPI_FLASH_CAP_SLOW_CHARGE)
#define USE_SPI_FLASH_CAP_SLOW_CHARGE                   1
#else
#define USE_SPI_FLASH_CAP_SLOW_CHARGE                   0
#endif // CFG_SPI_FLASH_CAP_SLOW_CHARGE
#else
#define USE_SPI_FLASH_CAP_SLOW_CHARGE                   0
#endif // __DA14531__ && CFG_SPI_FLASH_EXTENSIONS

#if defined (CFG_SPI_FLASH_ADESTO_UDPD)
#define USE_SPI_FLASH_ADESTO_UDPD                       1
#else
#define USE_SPI_FLASH_ADESTO_UDPD                       0
#endif // CFG_SPI_FLASH_ADESTO_UDPD

#if defined (CFG_SPI_FLASH_MEM_PROTECT_USING_STATUS_REG1)
#define USE_SPI_FLASH_MEM_PROTECT_USING_STATUS_REG1            1
#else
#define USE_SPI_FLASH_MEM_PROTECT_USING_STATUS_REG1            0
#endif // CFG_SPI_FLASH_MEM_PROTECT_USING_STATUS_REG1

// DA14585/586
#if defined (CFG_RETAIN_RAM_1_BLOCK) && defined (CFG_RETAIN_RAM_2_BLOCK) && defined (CFG_RETAIN_RAM_3_BLOCK)
#define DO_NOT_RETAIN_ALL_RAM_BLOCKS                          (0)
// DA14535
#elif defined (__DA14535__) && defined (CFG_RETAIN_RAM_1_BLOCK)
#define DO_NOT_RETAIN_ALL_RAM_BLOCKS                          (0)
// DA14531/DA14531-01
#elif defined (__DA14531__) && (defined (CFG_RETAIN_RAM_1_BLOCK) && defined (CFG_RETAIN_RAM_2_BLOCK))
#define DO_NOT_RETAIN_ALL_RAM_BLOCKS                          (0)
// No RAM block is retained - chip independent case
#else
#define DO_NOT_RETAIN_ALL_RAM_BLOCKS                          (1)
#endif

#if defined (CFG_SPIHDDR_CRC)
#define USE_SPIHDDR_CRC                                       (1)
#else
#define USE_SPIHDDR_CRC                                       (0)
#endif

// Applicable only to DA14535AA silicon
#if defined (CFG_DEFAULT_RF_LDO_REFRESH)
#define DEFAULT_RF_LDO_REFRESH                                (1)
#else
#define DEFAULT_RF_LDO_REFRESH                                (0)
#endif

// Applicable only to DA14535 silicon
#if defined (CFG_XTAL32M_DYN_FREQ_TRIMMING)
#define USE_XTAL32M_DYN_FREQ_TRIMMING                         (1)
#else
#define USE_XTAL32M_DYN_FREQ_TRIMMING                         (0)
#endif

// Macro used to build the characterization s/w for the module (the chip connected to SPI flash memory).
#if defined (CFG_CHARACTERIZATION_SW_FOR_MODULE)
#define USE_CHARACTERIZATION_SW_FOR_MODULE                    (1)
#else
#define USE_CHARACTERIZATION_SW_FOR_MODULE                    (0)
#endif
...
/* Note 
 * --------------------------
 * The following definitions  add an additional offset to the crystal start up and settling time in 
 * high temperatures. When operating in higher temperatures the time required for the crystal to 
 * start oscillating might be extended. Therefore the offset ensures that the device will wake up earlier 
 * to accomodate for the extended settling time and thus not miss events as would be the case when 
 * this effect is not taken into consideration. Please note that if the CFG_XTAL16M_ADAPTIVE_SETTLING 
 * macro is undefined and the CFG_DEVELOPMENT_DEBUG  macro is defined an ASSERT_WARNING(0) may be hit 
 * in the lld_sleep_compensate_func.Please review the respective notes within this function.
 */

#if !defined(__DA14531__) && USE_HIGH_TEMPERATURE
#define XTAL_HIGH_TEMP_LATENCY_STARTUP_USEC                 (1500)
#define XTAL_HIGH_TEMP_LATENCY_STARTUP_XTAL32_CYCLES        (50)
#else
#define XTAL_HIGH_TEMP_LATENCY_STARTUP_USEC                 (0)
#define XTAL_HIGH_TEMP_LATENCY_STARTUP_XTAL32_CYCLES        (0)
#endif // USE_HIGH_TEMPERATURE
...
#if defined (__DA14531__)
#if defined (__DA14535__)
#define DEFAULT_TEMPERATURE_CAL_VAL          (45147) // Typical value = ~705 * 64
#else
#define DEFAULT_TEMPERATURE_CAL_VAL          (30272) // Typical value = 473 * 64
#endif
#endif
...
/**
 ****************************************************************************************
 * @brief Configure/Setup the XTAL32M
 ****************************************************************************************
 */
